...
line 105
;103:
;104:void SG_DrawLevelStats( void )
;105:{
line 109
;106:    float font_scale;
;107:    vec2_t cursorPos;
;108:
;109:    font_scale = ImGui_GetFontScale();
ADDRLP4 12
...
pop
line 114
;114:        ImGui_SetWindowFontScale(font_scale * 3.5f);
ADDRLP4 0
INDIRF4
CNSTF4 1080033280
MULF4
...
line 128
;127:
;128:    sg.state = SG_SHOW_LEVEL_STATS;
ADDRGP4 sg+64
CNSTI4 2
ASGNI4
line 130
