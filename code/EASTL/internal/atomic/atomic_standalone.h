...
/////////////////////////////////////////////////////////////////////////////////
//
// bool atomic_eq(const eastl::atomic<T>*, const eastl::atomic<T>*)
//
template <typename T>
EASTL_FORCE_INLINE bool atomic_eq(const eastl::atomic<T>* atomic1, const eastl::atomic<T>* atomic2)
{
	return atomic1->load() == atomic2->load();
}

template <typename T>
EASTL_FORCE_INLINE bool atomic_eq(const eastl::atomic<T>* atomic1, typename eastl::atomic<T>::value_type value)
{
	return atomic1->load() == value;
}

/////////////////////////////////////////////////////////////////////////////////
//
// bool atomic_neq(const eastl::atomic<T>*, const eastl::atomic<T>*)
//
template <typename T>
EASTL_FORCE_INLINE bool atomic_neq(const eastl::atomic<T>* atomic1, const eastl::atomic<T>* atomic2)
{
	return atomic1->load() != atomic2->load();
}

template <typename T>
EASTL_FORCE_INLINE bool atomic_neq(const eastl::atomic<T>* atomic1, typename eastl::atomic<T>::value_type value)
{
	return atomic1->load() != value;
}
...
/////////////////////////////////////////////////////////////////////////////////
//
// bool atomic_gt(const eastl::atomic<T>*, const eastl::atomic<T>*)
//
template <typename T>
EASTL_FORCE_INLINE bool atomic_gt(const eastl::atomic<T>* atomic1, const eastl::atomic<T>* atomic2)
{
	return atomic1->load() > atomic2->load();
}

template <typename T>
EASTL_FORCE_INLINE bool atomic_gt(const eastl::atomic<T>* atomic1, typename eastl::atomic<T>::value_type value)
{
	return atomic1->load() > value;
}
...
/////////////////////////////////////////////////////////////////////////////////
//
// bool atomic_lt(const eastl::atomic<T>*, const eastl::atomic<T>*)
//
template <typename T>
EASTL_FORCE_INLINE bool atomic_lt(const eastl::atomic<T>* atomic1, const eastl::atomic<T>* atomic2)
{
	return atomic1->load() < atomic2->load();
}

template <typename T>
EASTL_FORCE_INLINE bool atomic_lt(const eastl::atomic<T>* atomic1, typename eastl::atomic<T>::value_type value)
{
	return atomic1->load() < value;
}
