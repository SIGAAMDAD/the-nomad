...
struct ImVec2
{
    ...
    ImVec2& operator=(const ImVec3& b);
...
struct ImVec3
{
    ...
    ImVec3& operator=(const ImVec2& a);
    float& operator[] (size_t idx)          { IM_ASSERT(idx == 0 || idx == 1); return ((float*)(void*)(char*)this)[idx]; } // We very rarely use this [] operator, so the assert overhead is fine.
    float  operator[] (size_t idx) const    { IM_ASSERT(idx == 0 || idx == 1); return ((const float*)(const void*)(const char*)this)[idx]; }
...
inline ImVec2& ImVec2::operator=(const ImVec3& b)
{
    x = b.x;
    y = b.y;
    return *this;
...
inline ImVec3& ImVec3::operator=(const ImVec2& b)
{
    x = b.x;
    y = b.y;
    return *this;
...
namespace ImGui
{
    ...
    IMGUI_API bool          InputText(const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL, ImGuiInputTextCallbackData *callbackData = NULL);
