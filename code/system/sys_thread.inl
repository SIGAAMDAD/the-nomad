...
#define Msg( x ) Con_Printf( COLOR_YELLOW "WARNING: " x "" )
#define DevWarning( x ) Con_DPrintf( COLOR_YELLOW "WARNING: " x "" )
...
#define INLINE_ON_PS3 GDR_INLINE
#else
...
#else
	eastl::unique_ptr<ThreadInit_t> pInit((ThreadInit_t *)pv);
#endif
