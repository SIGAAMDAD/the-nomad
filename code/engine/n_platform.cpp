...
static void Sys_GetProcess_UsedRAM( sys_stats_t *stats )
{
#ifdef _WIN32
...
void Sys_GetSystemStats( sys_stats_t *stats )
{
    stats->cpuUsage = Sys_GetCPUUsage();
}

void Sys_DisplayStats( void )
{
    sys_stats_t stats;

    Sys_GetSystemStats( &stats );
}
