...
#define MAX_GDR_PATH 64
	...
	// get msvc to shut up about us using normal standard library functions instead of their
	// implementations
	...
	// _MSC_VER is more reliably defined, but sometimes only _MSVC_VER is defined
	#if defined(_MSVC_VER) && !defined(_MSC_VER)
		#define _MSC_VER _MSVC_VER
	#endif
...
#pragma warning(disable : 4242)		// conversion from '__int64' to 'int', possible loss of data
#pragma warning(disable : 4018)     // signed/unsigned mismatch
#pragma warning(disable : 4703)		// potentially uninitialized pointer variable used (in most cases, msvc is wrong)
#endif
