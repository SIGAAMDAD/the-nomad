...
void DataBaseMenu_Draw( void )
{
	...
	ImGui::Begin( "##DataBaseMenu", NULL, ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoTitleBar
	...
	ImGui::BeginChild( ImGui::GetID( "EntryDraw" ), ImVec2( 700 * ui->scale, ( 768 - 64 ) * ui->scale ), ImGuiChildFlags_None,
		ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoTitleBar
		| ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoBringToFrontOnFocus );
	ImGui::PushStyleColor( ImGuiCol_WindowBg, colorLtGrey );
...
void DataBaseMenu_Cache( void )
{
	...
	s_dataBase->menu.track = Snd_RegisterSfx( "event:/music/menu/main_theme" );
