...
typedef struct {
	...
	menuswitch_t enablePostProcessing;
...
void PerformanceSettingsMenu_Save( void )
{
	...
	Cvar_SetIntegerValue( "r_toneMapType", s_performanceOptionsInfo->toneMappingType.curitem );
	...
	Cvar_SetIntegerValue( "r_textureFilter", s_perforamnceOptionsInfo->textureFilterList.curitem );
...
static void PerformanceMenu_SetHint( void *ptr, int event )
{
	...
	s_performanceOptionsInfo->itemFocus = (menucommon_t *)ptr;
}
...
void PerformanceSettingsMenu_Cache( void )
{
    ...
    s_performanceOptionsInfo->save.generic.font = FontCache()->;
    ...
    s_performanceOptionsInfo->video.color_white = color_white;
    ...
    s_performanceOptionsInfo->performance.color_white = color_white;
    ...
    s_performanceOptionsInfo->audio.color_white = color_white;
    ...
    s_performanceOptionsInfo->controls.color_white = color_white;
    ...
    s_performanceOptionsInfo->gameplay.color_white = color_white;
    ...
    s_performanceOptionsInfo->multisampleType.generic.eventcallback = PerfomanceMenu_SetHint;
    ...
    s_performanceOptionsInfo->anisotropicFiltering.generic.eventcallback = PerfomanceMenu_SetHint;
    ...
    s_performanceOptionsInfo->textureDetail.generic.eventcallback = PerfomanceMenu_SetHint;
    ...
    s_performanceOptionsInfo->textureFiltering.generic.type = MTYPE_TEXT;
    s_performanceOptionsInfo->textureFiltering.generic.id = ID_TEXTUREFILTER;
    s_performanceOptionsInfo->textureFiltering.generic.flags = QMF_HIGHLIGHT_IF_FOCUS;
    s_performanceOptionsInfo->textureFiltering.generic.eventcallback = PerfomanceMenu_SetHint;
    s_performanceOptionsInfo->textureFiltering.generic.font = RobotoMono;
    s_performanceOptionsInfo->textureFiltering.text = "Texture Filtering";
    s_performanceOptionsInfo->textureFiltering.color = color_white;
    ...
    s_performanceOptionsInfo->enableAmbientOcclusion.generic.eventcallback = PerfomanceMenu_SetHint;
    ...
    s_performanceOptionsInfo->enableHDR.generic.eventcallback = PerfomanceMenu_SetHint;
    ...
    s_performanceOptionsInfo->enablePBR.generic.eventcallback = PerfomanceMenu_SetHint;
    ...
    s_performanceOptionsInfo->enableBloom.generic.eventcallback = PerfomanceMenu_SetHint;
    ...
    s_performanceOptionsInfo->enableToneMapping.generic.eventcallback = PerfomanceMenu_SetHint;
    ...
    s_performanceOptionsInfo->enableDynamicLighting.generic.eventcallback = PerfomanceMenu_SetHint;
    ...
    s_performanceOptionsInfo->enableVertexLighting.generic.eventcallback = PerfomanceMenu_SetHint;
    ...
    s_performanceOptionsInfo->toneMappingType.generic.eventcallback = PerfomanceMenu_SetHint;
    ...
    s_performanceOptionsInfo->multisampleLeft.generic.id = ID_MULTISAMPLE;
    ...
    s_performanceOptionsInfo->multisampleRight.generic.id = ID_MULTISAMPLE;
    ...
    s_performanceOptionsInfo->toneMappingTypeLeft.data = (menucommon_t *)&s_performanceOptionsInfo->toneMappingTypeLists;
    ...
    s_performanceOptionsInfo->textureFilterLeft.generic.id = ID_TEXTUREFILTERING;
    ...
    s_performanceOptionsInfo->textureFilterRight.generic.id = ID_TEXTUREFILTERING;
    ...
    s_performanceOptionsInfo->textureFilterList.generic.id = ID_TEXTUREFILTERING;
    s_performanceOptionsInfo->textureFilterList.generic.eventcallback = PerformanceMenu_Update;
    ...
    s_performanceOptionsInfo->multisampleList.generic.id = ID_MULTISAMPLE;
    s_performanceOptionsInfo->multisampleList.generic.eventcallback = PerformanceMenu_Update;
    ...
    s_performanceOptionsInfo->anisotropyList.generic.id = ID_MULTISAMPLE;
    s_performanceOptionsInfo->anisotropyList.generic.eventcallback = PerformanceMenu_Update;
    ...
    s_performanceOptionsInfo->tabs.items[0] = &s_performanceOptionsInfo->video;
	s_performanceOptionsInfo->tabs.items[1] = &s_performanceOptionsInfo->performance;
	s_performanceOptionsInfo->tabs.items[2] = &s_performanceOptionsInfo->audio;
	s_performanceOptionsInfo->tabs.items[3] = &s_performanceOptionsInfo->controls;
	s_performanceOptionsInfo->tabs.items[4] = &s_performanceOptionsInfo->gameplay;
	...
	
	{
	    ...
	    Table_AddRow( &s_performanceOptionsInfo->graphicsTable );
	    Table_AddItem( &s_performanceOptionsInfo->graphicsTable, &s_performanceOptionsInfo->textureFiltering );
...
static void PerformanceSettingsMenu_InitTheNerdyShit( void )
{
    ...
    s_performanceOptionsInfo->enableSpecularMaps.generic.eventcallback = PerfomanceMenu_SetHint;
    ...
    s_performanceOptionsInfo->enableNormalMaps.generic.eventcallback = PerfomanceMenu_SetHint;
