...
*/
template< class type >
GDR_INLINE uint32_t idBinSearch_Less( const type *array, const uint32_t arraySize, const type &value ) {
	uint32_t len = arraySize;
	uint32_t mid = len;
	uint32_t offset = 0;
	while( mid > 0 ) {
		mid = len >> 1;
...
*/
template< class type >
GDR_INLINE uint32_t idBinSearch_LessEqual( const type *array, const uint32_t arraySize, const type &value ) {
	uint32_t len = arraySize;
	uint32_t mid = len;
	uint32_t offset = 0;
	while( mid > 0 ) {
...
*/
template< class type >
GDR_INLINE uint32_t idBinSearch_Greater( const type *array, const uint32_t arraySize, const type &value ) {
	uint32_t len = arraySize;
	uint32_t mid = len;
	uint32_t offset = 0;
	uint32_t res = 0;
...
*/
template< class type >
GDR_INLINE uint32_t idBinSearch_GreaterEqual( const type *array, const uint32_t arraySize, const type &value ) {
	uint32_t len = arraySize;
	uint32_t mid = len;
	uint32_t offset = 0;
	uint32_t res = 0;
