#ifndef __MODULE_JIT__
#define __MODULE_JIT__
...
using UtlMultimap = eastl::multimap<Key, T, eastl::less<Key>, CModuleAllocator>;
...
class asCJITCompiler : public asIJITCompiler {
    ...
    UtlMultimap<asJITFunction, assembler::CodePage *> pages;
	assembler::CriticalSection *lock;

	unsigned flags;

	UtlMultimap<asJITFunction, unsigned char **> jumpTables;
	...
	UtlMultimap<asIScriptFunction *, DeferredCodePointer> deferredPointers;
public:
