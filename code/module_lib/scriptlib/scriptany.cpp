...
void RegisterScriptAny_Native( asIScriptEngine *engine )
{
	...
	CheckASCall( engine->RegisterObjectMethod( "any", "void store(const int8&in)", asMETHODPR(CScriptAny,Store,(int8_t&),void), asCALL_THISCALL ) );
	CheckASCall( engine->RegisterObjectMethod( "any", "void store(const int16&in)", asMETHODPR(CScriptAny,Store,(int16_t&),void), asCALL_THISCALL ) );
	CheckASCall( engine->RegisterObjectMethod( "any", "void store(const int32&in)", asMETHODPR(CScriptAny,Store,(int32_t&),void), asCALL_THISCALL ) );
	CheckASCall( engine->RegisterObjectMethod( "any", "void store(const int64&in)", asMETHODPR(CScriptAny,Store,(int64_t&),void), asCALL_THISCALL ) );
	CheckASCall( engine->RegisterObjectMethod( "any", "void store(const uint8&in)", asMETHODPR(CScriptAny,Store,(uint8_t&),void), asCALL_THISCALL ) );
	CheckASCall( engine->RegisterObjectMethod( "any", "void store(const uint16&in)", asMETHODPR(CScriptAny,Store,(uint16_t&),void), asCALL_THISCALL ) );
	CheckASCall( engine->RegisterObjectMethod( "any", "void store(const uint32&in)", asMETHODPR(CScriptAny,Store,(uint32_t&),void), asCALL_THISCALL ) );
	CheckASCall( engine->RegisterObjectMethod( "any", "void store(const uint64&in)", asMETHODPR(CScriptAny,Store,(uint64_t&),void), asCALL_THISCALL ) );
	...
	CheckASCall( engine->RegisterObjectMethod( "any", "bool load(int8&out)", asMETHODPR(CScriptAny,Retrieve,(int8_t&) const,bool), asCALL_THISCALL ) );
	CheckASCall( engine->RegisterObjectMethod( "any", "bool load(int16&out)", asMETHODPR(CScriptAny,Retrieve,(int16_t&) const,bool), asCALL_THISCALL ) );
	CheckASCall( engine->RegisterObjectMethod( "any", "bool load(int32&out)", asMETHODPR(CScriptAny,Retrieve,(int32_t&) const,bool), asCALL_THISCALL ) );
	CheckASCall( engine->RegisterObjectMethod( "any", "bool load(int64&out)", asMETHODPR(CScriptAny,Retrieve,(int64_t&) const,bool), asCALL_THISCALL ) );
	CheckASCall( engine->RegisterObjectMethod( "any", "bool load(uint8&out)", asMETHODPR(CScriptAny,Retrieve,(uint8_t&) const,bool), asCALL_THISCALL ) );
	CheckASCall( engine->RegisterObjectMethod( "any", "bool load(uint16&out)", asMETHODPR(CScriptAny,Retrieve,(uint16_t&) const,bool), asCALL_THISCALL ) );
	CheckASCall( engine->RegisterObjectMethod( "any", "bool load(uint32&out)", asMETHODPR(CScriptAny,Retrieve,(uint32_t&) const,bool), asCALL_THISCALL ) );
	CheckASCall( engine->RegisterObjectMethod( "any", "bool load(uint64&out)", asMETHODPR(CScriptAny,Retrieve,(uint64_t&) const,bool), asCALL_THISCALL ) );
