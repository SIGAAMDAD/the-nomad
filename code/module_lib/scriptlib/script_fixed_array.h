...
protected:
	...
	void DeleteBuffer( SFixedArrayBuffer *buffer );
	...
	void  CreateBuffer( SFixedArrayBuffer **buffer, asUINT numElements);
	void  CopyBuffer( SFixedArrayBuffer *dst, SFixedArrayBuffer *src );
	void  Construct( SFixedArrayBuffer *buf, asUINT start, asUINT end );
	void  Destruct( SFixedArrayBuffer *buf, asUINT start, asUINT end );
	bool  Equals(const void *a, const void *b, asIScriptContext *ctx, SFixedArrayCache *cache) const;
};
