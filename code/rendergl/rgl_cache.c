...
void R_InitGPUBuffers(void)
{
	...
	backend.drawBuffer->attribs[ATTRIB_INDEX_WORLDPOS].offset		= offsetof( polyVert_t, worldPos );
	...
	backend.drawBuffer->attribs[ATTRIB_INDEX_WORLDPOS].stride		= sizeof(polyVert_t);
