...
//	const float weights[5] = float[]( 0.2270270270, 0.1945945946, 0.1216216216, 0.0540540541, 0.0162162162 );
	...
	if ( u_BlurHorizontal ) {
		...
		result += texture( u_DiffuseMap, v_TexCoords + vec2( texOffset.x * 2, 0.0 ) ).rgb * 0.1216216216;
		result += texture( u_DiffuseMap, v_TexCoords - vec2( texOffset.x * 2, 0.0 ) ).rgb * 0.1216216216;

		result += texture( u_DiffuseMap, v_TexCoords + vec2( texOffset.x * 3, 0.0 ) ).rgb * 0.0540540541;
		result += texture( u_DiffuseMap, v_TexCoords - vec2( texOffset.x * 3, 0.0 ) ).rgb * 0.0540540541;

		result += texture( u_DiffuseMap, v_TexCoords + vec2( texOffset.x * 4, 0.0 ) ).rgb * 0.0162162162;
		result += texture( u_DiffuseMap, v_TexCoords - vec2( texOffset.x * 4, 0.0 ) ).rgb * 0.0162162162;
	#endif
	}
	else {
	...
	#else
		result += texture( u_DiffuseMap, v_TexCoords + vec2( 0.0, texOffset.y * 1 ) ).rgb * 0.1945945946;
		result += texture( u_DiffuseMap, v_TexCoords - vec2( 0.0, texOffset.y * 1 ) ).rgb * 0.1945945946;

		result += texture( u_DiffuseMap, v_TexCoords + vec2( 0.0, texOffset.y * 2 ) ).rgb * 0.1216216216;
		result += texture( u_DiffuseMap, v_TexCoords - vec2( 0.0, texOffset.y * 2 ) ).rgb * 0.1216216216;

		result += texture( u_DiffuseMap, v_TexCoords + vec2( 0.0, texOffset.y * 3 ) ).rgb * 0.0540540541;
		result += texture( u_DiffuseMap, v_TexCoords - vec2( 0.0, texOffset.y * 3 ) ).rgb * 0.0540540541;

		result += texture( u_DiffuseMap, v_TexCoords + vec2( 0.0, texOffset.y * 4 ) ).rgb * 0.0162162162;
		result += texture( u_DiffuseMap, v_TexCoords - vec2( 0.0, texOffset.y * 4 ) ).rgb * 0.0162162162;
	#endif
	}
