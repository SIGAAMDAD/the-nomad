...
TEXTURE2D u_EdgesTexture;
TEXTURE2D u_AreaTexture;
TEXTURE2D u_SearchTexture;
...
void main() {
	...
	if ( e.r > 0.0 ) { // Edge at west
		...
		vec3 coords;
		coords.y = SMAASearchYUp( u_EdgesTexture, u_SearchTexture, v_Offset[1].xy, v_Offset[2].z );
