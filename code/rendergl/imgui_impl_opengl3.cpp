...
//  2020-10-15: OpenGL: Use glGetString(GL_VERSION) instead of nglGetIntegerv(GL_MAJOR_VERSION, ...) when the later returns zero (e.g. Desktop GL 2.x)
...
#define IMGUI_IMPL_OPENGL_CUSTOM_LOADER
#include "ngl.h"
...
// Functions
extern "C" bool    ImGui_ImplOpenGL3_Init(const char* glsl_version)
{
