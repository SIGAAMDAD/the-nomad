...
//		R_VaoPackColor( verts[0].color.rgb, backend.color2D );
//		R_VaoPackColor( verts[1].color.rgb, backend.color2D );
//		R_VaoPackColor( verts[2].color.rgb, backend.color2D );
//		R_VaoPackColor( verts[3].color.rgb, backend.color2D );
	}
